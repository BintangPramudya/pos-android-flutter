import 'package:bintang_kasir/app/data/repository/auth_repository.dart';
import 'package:bintang_kasir/app/data/repository/order_repository.dart';
import 'package:bintang_kasir/app/data/repository/payment_method_repository.dart';
import 'package:bintang_kasir/app/data/repository/product_repository.dart';
import 'package:bintang_kasir/app/data/repository/setting_repository.dart';
import 'package:bintang_kasir/app/data/source/auth_api_service.dart';
import 'package:bintang_kasir/app/data/source/order_api_service.dart';
import 'package:bintang_kasir/app/data/source/payment_method_api_service.dart';
import 'package:bintang_kasir/app/data/source/product_api_service.dart';
import 'package:bintang_kasir/app/data/source/setting_api_service.dart';
import 'package:bintang_kasir/app/domain/entity/order.dart';
import 'package:bintang_kasir/app/domain/entity/product.dart';
import 'package:bintang_kasir/app/domain/repository/auth_repository.dart';
import 'package:bintang_kasir/app/domain/repository/order_repository.dart';
import 'package:bintang_kasir/app/domain/repository/payment_method_repository.dart';
import 'package:bintang_kasir/app/domain/repository/product_repository.dart';
...
import 'package:bintang_kasir/app/presentation/input_order/input_order_notifier.dart';
...
import 'package:bintang_kasir/core/network/app_interceptor.dart';
